...
// if (yearOfBirth % 4 === 0) {
//   console.log(`Рік вашого народження, ${yearOfBirth}, був високосним`);
// } else {
//   console.log(`Рік вашого народження, ${yearOfBirth}, не був високосним`);
// }
...
// const userNumber = prompt("Вгадайте чиисло від 1 до 10");

// if (Number(userNumber) === randomNumber) {
//   console.log(`Вітаю ви вгадали число ${randomNumber}`);
// } else {
//   console.log(`Ви програли, компютер загадав ${randomNumber}`);
// }
...
// const a = prompt("Введіть перше число вашої математичної операції");
// const b = prompt("Введіть друге число вашої математичної операції");
// const c = prompt(
//   "Введіть знак + - * / з яким ви хочете провести математичну отперацію"
// );
// let result;
...
//   case "+":
//     result = a + b;
//     console.log(`Сума чисел a i b = ${result}`);
//     break;

//   case "-":
//     result = a - b;
//     console.log(`Різниця чисел a i b = ${result}`);
//     break;

//   case "*":
//     result = a * b;
//     console.log(`Добуток чисел a i b = ${result}`);
//     break;

//   case "/":
//     result = a / b;
//     console.log(`Частка чисел a i b = ${result}`);
//     break;

//   default:
//     console.log("Ви ввели невірний знак для проведення математичної операції");
// }
...
// if (Number(inputNumber) >= 55 && Number(inputNumber) <= 99) {
//   console.log(`Введене число входить у вказаний діапазон`);
// } else {
//   console.log(`Введене число не входить у вказаний діапазон`);
// }
...
// до болонського формату 89 - 100 це A 75 - 88 це В 60 - 74 це С 45 - 59 це D 20 - 44 це Е до 20 це F
